...
export class GroupByEnumerator<TSource, TKey, TValue, TResult> extends TyneqSourceEnumerator<TSource, TResult> {
    ...
    private readonly groupFactory: (values: TValue[]) => ITyneqEnumerable<TValue>;
     ...
     * @param groupFactory - Creates an {@link ITyneqEnumerable} wrapping a group's value array.
     */
    public constructor(
        ...
        groupFactory: (values: TValue[]) => ITyneqEnumerable<TValue>
    ) {
