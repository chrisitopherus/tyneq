 ...
 * with signature `(source: Enumerable<TSource>, ...userArgs: TArgs)`, and implement
 ...
 *     public constructor(source: Enumerable<T>) { super(source); }
 ...
 *     public constructor(source: Enumerable<T>, private readonly index: number) { super(source); }
 *     public process(): T { ... }
 * }
 * ```
 */
