...
import { builtinOperator } from "../../../src/extensibility/builtinOperator";
import { builtinTerminal } from "../../../src/extensibility/builtinTerminal";
import {
  getOperatorMetadata,
  IOperatorMetadataCarrier,
} from "../../../src/queryplan/operatorMetadata";
import { WhereEnumerator } from "../../../src/operators/streaming/where";
import { AllOperator } from "../../../src/operators/terminal/all";
